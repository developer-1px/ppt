...
- Without `PPTX_RENDER_FILE`, `pnpm verify:pptx-render` creates a temporary 3-slide `.pptx` file with slide backgrounds, text, shapes, lines, hyperlinks, a grouped object, a table, and a cropped/flipped image on disk and opens it.
