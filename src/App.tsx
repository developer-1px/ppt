...
const PPT_OBJECT_ACCESSIBILITY_IMPORT_MODEL =
  'ppt-object-accessibility-import' as const
const PPT_OBJECT_ACCESSIBILITY_JSON_IMPORT_FORMAT =
  'application-json-ppt-object-accessibility' as const
const PPT_OBJECT_ACCESSIBILITY_JSON_MIME_TYPE =
  'application/vnd.interactive-os.ppt.object-accessibility+json'
...
const PPT_OBJECT_FILL_OPACITY_IMPORT_MODEL =
  'ppt-object-fill-opacity-import' as const
const PPT_OBJECT_FILL_OPACITY_JSON_IMPORT_FORMAT =
...
const PPT_TEXT_FONT_SIZE_IMPORT_MODEL =
  'ppt-text-font-size-import' as const
const PPT_TEXT_FONT_SIZE_JSON_IMPORT_FORMAT =
  'application-json-ppt-text-font-size' as const
const PPT_TEXT_FONT_SIZE_JSON_MIME_TYPE =
  'application/vnd.interactive-os.ppt.text-font-size+json'
const PPT_TEXT_FONT_WEIGHT_IMPORT_MODEL =
  'ppt-text-font-weight-import' as const
const PPT_TEXT_FONT_WEIGHT_JSON_IMPORT_FORMAT =
  'application-json-ppt-text-font-weight' as const
const PPT_TEXT_FONT_WEIGHT_JSON_MIME_TYPE =
...
type PPTObjectAccessibilityImportField = 'altText'
type PPTObjectAccessibilityImportSource = {
  altText: string | null
...
type PPTObjectFillOpacityImportField = 'fillOpacity'
type PPTObjectFillOpacityImportSource = {
...
type PPTTextFontSizeImportField =
  ...
  | 'textFontSize'
  | 'value'
type PPTTextFontSizeImportSource = {
  fields: readonly PPTTextFontSizeImportField[]
  fontSize: number
  format: typeof PPT_TEXT_FONT_SIZE_JSON_IMPORT_FORMAT
  jsonLength: number
}
type PPTTextFontWeightImportField =
  | 'bold'
  | 'fontWeight'
  | 'textFontWeight'
  | 'value'
  | 'weight'
type PPTTextFontWeightImportSource = {
  fields: readonly PPTTextFontWeightImportField[]
  fontWeight: NonNullable<PPTTextStyle['fontWeight']>
...
type PPTObjectAccessibilityImportEffect = {
  ...
  format: typeof PPT_OBJECT_ACCESSIBILITY_JSON_IMPORT_FORMAT
  jsonLength: number
  model: typeof PPT_OBJECT_ACCESSIBILITY_IMPORT_MODEL
  objectIds: string
  slideId: string
}
...
type PPTObjectFillOpacityImportEffect = {
  commandFields: string
  commandIds: string
  commandTargets: string
  commandTypes: string
...
type PPTTextFontSizeImportEffect = {
  ...
  format: typeof PPT_TEXT_FONT_SIZE_JSON_IMPORT_FORMAT
  jsonLength: number
  model: typeof PPT_TEXT_FONT_SIZE_IMPORT_MODEL
  objectIds: string
}
type PPTTextFontWeightImportEffect = {
  ...
  format: typeof PPT_TEXT_FONT_WEIGHT_JSON_IMPORT_FORMAT
  jsonLength: number
  model: typeof PPT_TEXT_FONT_WEIGHT_IMPORT_MODEL
  objectIds: string
}
...
function App() {
  ...
  const [lastObjectAccessibilityImportEffect, setLastObjectAccessibilityImportEffect] =
    useState<PPTObjectAccessibilityImportEffect | null>(null)
  ...
  const [lastTextFontSizeImportEffect, setLastTextFontSizeImportEffect] =
    useState<PPTTextFontSizeImportEffect | null>(null)
  const [lastTextFontWeightImportEffect, setLastTextFontWeightImportEffect] =
    useState<PPTTextFontWeightImportEffect | null>(null)
  ...
  function pastePPTTextFontSizeSource(source: PPTTextFontSizeImportSource) {
    const textElements = selectedElements.filter((element): element is PPTTextElement =>
      isPPTTextElement(element) &&
        element.locked !== true &&
        element.visible !== false)
  ...
  function pastePPTTextFontWeightSource(
    ...
    <main className="ppt-app" data-ppt-app data-theme={theme}>
      ...
      <section
        ...
        data-ppt-accessibility-command-value={lastAccessibilityEffect?.payload.id === 'update-object-accessibility'
          ...
          : undefined}
        data-ppt-accessibility-import-alt-text-length={lastObjectAccessibilityImportEffect?.altTextLength}
        data-ppt-accessibility-import-alt-text-present={lastObjectAccessibilityImportEffect?.altTextPresent}
        data-ppt-accessibility-import-command-fields={lastObjectAccessibilityImportEffect?.commandFields}
        data-ppt-accessibility-import-command-targets={lastObjectAccessibilityImportEffect?.commandTargets}
        data-ppt-accessibility-import-command-types={lastObjectAccessibilityImportEffect?.commandTypes}
        data-ppt-accessibility-import-command-values={lastObjectAccessibilityImportEffect?.commandValues}
        data-ppt-accessibility-import-commands={lastObjectAccessibilityImportEffect?.commandIds}
        data-ppt-accessibility-import-fields={lastObjectAccessibilityImportEffect?.fields}
        data-ppt-accessibility-import-format={lastObjectAccessibilityImportEffect?.format}
        data-ppt-accessibility-import-json-length={lastObjectAccessibilityImportEffect?.jsonLength}
        data-ppt-accessibility-import-model={lastObjectAccessibilityImportEffect?.model}
        data-ppt-accessibility-import-objects={lastObjectAccessibilityImportEffect?.objectIds}
        data-ppt-accessibility-import-slide={lastObjectAccessibilityImportEffect?.slideId}
        ...
        data-ppt-fill-opacity-import-command-fields={lastObjectFillOpacityImportEffect?.commandFields}
        data-ppt-fill-opacity-import-command-targets={lastObjectFillOpacityImportEffect?.commandTargets}
        data-ppt-fill-opacity-import-command-types={lastObjectFillOpacityImportEffect?.commandTypes}
        data-ppt-fill-opacity-import-command-values={lastObjectFillOpacityImportEffect?.commandValues}
        data-ppt-fill-opacity-import-commands={lastObjectFillOpacityImportEffect?.commandIds}
        data-ppt-fill-opacity-import-fields={lastObjectFillOpacityImportEffect?.fields}
        data-ppt-fill-opacity-import-format={lastObjectFillOpacityImportEffect?.format}
        data-ppt-fill-opacity-import-json-length={lastObjectFillOpacityImportEffect?.jsonLength}
        data-ppt-fill-opacity-import-model={lastObjectFillOpacityImportEffect?.model}
        data-ppt-fill-opacity-import-objects={lastObjectFillOpacityImportEffect?.objectIds}
        data-ppt-fill-opacity-import-slide={lastObjectFillOpacityImportEffect?.slideId}
        data-ppt-fill-opacity-import-value={lastObjectFillOpacityImportEffect?.fillOpacity}
        ...
        data-ppt-text-font-size-import-model={lastTextFontSizeImportEffect?.model}
        data-ppt-text-font-size-import-objects={lastTextFontSizeImportEffect?.objectIds}
        ...
        data-ppt-text-font-weight-import-model={lastTextFontWeightImportEffect?.model}
        data-ppt-text-font-weight-import-objects={lastTextFontWeightImportEffect?.objectIds}
        data-ppt-text-font-weight-import-value={lastTextFontWeightImportEffect?.fontWeight}
...
function createPPTObjectAccessibilityImportEffect({
  effects,
  source,
}: {
  effects: readonly SlideEditObjectAccessibilityHostCommandEffect<string, string>[]
  source: PPTObjectAccessibilityImportSource
}): PPTObjectAccessibilityImportEffect {
  return {
    altTextLength: source.altText?.length ?? 0,
    altTextPresent: String(source.altText !== null),
    commandFields: effects.map((effect) =>
      effect.payload.id === 'update-object-accessibility'
    ...
    format: source.format,
    jsonLength: source.jsonLength,
    model: PPT_OBJECT_ACCESSIBILITY_IMPORT_MODEL,
    objectIds: uniquePPTCanvasValues(
      effects.map((effect) => effect.payload.objectId),
    ).join(' '),
    slideId: effects[0]?.payload.slideId ?? '',
...
function createPPTObjectAccessibilityImportCommandEffects({
  objectIds,
  slideId,
  source,
}: {
...
function createPPTObjectFillOpacityImportEffect({
  effects,
  source,
}: {
  effects: readonly SlideEditObjectFillOpacityHostCommandEffect<string, string>[]
  source: PPTObjectFillOpacityImportSource
}): PPTObjectFillOpacityImportEffect {
  return {
    commandFields: effects.map((effect) => effect.payload.fieldId).join(' '),
    commandIds: effects.map((effect) => effect.payload.id).join(' '),
    commandTargets: effects.map((effect) => effect.payload.objectId).join(' '),
    ...
    commandValues: effects.map((effect) => String(effect.payload.value)).join(' '),
    fields: source.fields.join(' '),
    fillOpacity: String(source.fillOpacity),
    format: source.format,
    jsonLength: source.jsonLength,
...
function getPPTObjectAccessibilitySourceFromDataTransfer(
  dataTransfer: DataTransfer | null,
) {
  if (!dataTransfer) {
    return null
...
function getPPTObjectAccessibilitySourceFromText(
  ...
  try {
    return getPPTObjectAccessibilitySourceFromJSONValue(
      JSON.parse(json),
      json.length,
      allowDirect,
    )
...
function getPPTObjectAccessibilitySourceFromJSONValue(
  value: unknown,
  jsonLength: number,
  allowDirect: boolean,
): PPTObjectAccessibilityImportSource | null {
  const altText = getPPTObjectAccessibilityAltTextFromJSONValue(
    getPPTObjectAccessibilityPayloadValue(value, allowDirect),
  )
...
function getPPTObjectAccessibilityPayloadValue(
  ...
  if (value.objectAccessibility !== undefined) {
...
function getPPTObjectAccessibilityAltTextFromJSONValue(
  ...
  const raw = value.altText ?? value.text ?? value.value
...
function getPPTObjectFillOpacitySourceFromDataTransfer(
  dataTransfer: DataTransfer | null,
) {
  if (!dataTransfer) {
    return null
  ...
  for (const candidate of candidates) {
    ...
    const source = getPPTObjectFillOpacitySourceFromText(
      text,
      candidate.allowDirect,
    )
...
function getPPTObjectFillOpacitySourceFromText(
  text: string,
  allowDirect: boolean,
  ...
  try {
    return getPPTObjectFillOpacitySourceFromJSONValue(
      JSON.parse(json),
      json.length,
      allowDirect,
    )
...
function getPPTObjectFillOpacitySourceFromJSONValue(
  value: unknown,
  jsonLength: number,
  allowDirect: boolean,
): PPTObjectFillOpacityImportSource | null {
  const fillOpacity = getPPTObjectFillOpacityFromJSONValue(
    getPPTObjectFillOpacityPayloadValue(value, allowDirect),
  )

  return fillOpacity === undefined
    ? null
    : {
        fields: ['fillOpacity'],
        fillOpacity,
...
function getPPTObjectFillOpacityPayloadValue(
  value: unknown,
  allowDirect: boolean,
): unknown {
  if (!isPPTRecord(value)) {
  ...
  if (value.shapeFillOpacity !== undefined) {
    return value.shapeFillOpacity
  }

  if (value.fillOpacity !== undefined) {
    return value.fillOpacity
  }
...
function getPPTObjectFillOpacityFromJSONValue(
  value: unknown,
): number | undefined {
  const raw = isPPTRecord(value)
    ? value.fillOpacity ?? value.opacity ?? value.value ?? value.amount
    : value

  if (typeof raw === 'number') {
    return Number.isFinite(raw) ? normalizePPTFillOpacity(raw) : undefined
  }
...
function getPPTTextFontSizeSourceFromDataTransfer(
  dataTransfer: DataTransfer | null,
) {
  if (!dataTransfer) {
    return null
  ...
  for (const candidate of candidates) {
    ...
    const source = getPPTTextFontSizeSourceFromText(
      text,
      candidate.allowDirect,
    )
...
function getPPTTextFontSizeSourceFromText(
  text: string,
  allowDirect: boolean,
  ...
  if (!json) {
    ...
    try {
      return getPPTTextFontSizeSourceFromJSONValue(
        JSON.parse(rawText),
        rawText.length,
        true,
      )
...
function getPPTTextFontSizeSourceFromJSONValue(
  value: unknown,
  jsonLength: number,
  allowDirect: boolean,
): PPTTextFontSizeImportSource | null {
  const payload = getPPTTextFontSizePayloadEntry(value, allowDirect)

  if (!payload) {
    return null
  }

  const fontSize = getPPTTextFontSizeImportValueFromJSONValue(
    payload.value,
  )
...
function getPPTTextFontSizePayloadEntry(
  value: unknown,
  allowDirect: boolean,
): {
  fields: readonly PPTTextFontSizeImportField[]
...
function getPPTTextFontSizeImportValueFromJSONValue(
  value: unknown,
): number | undefined {
  if (isPPTRecord(value)) {
    return getPPTTextFontSizeImportValueFromJSONValue(
      value.value ??
        value.fontSize ??
        value.size ??
        value.textFontSize,
...
function getPPTTextFontWeightSourceFromDataTransfer(
  ...
  for (const candidate of candidates) {
    ...
    const source = getPPTTextFontWeightSourceFromText(
      text,
      candidate.allowDirect,
    )
...
function getPPTTextFontWeightSourceFromText(
  text: string,
  allowDirect: boolean,
  ...
  if (!json) {
    ...
    try {
      return getPPTTextFontWeightSourceFromJSONValue(
        JSON.parse(rawText),
        rawText.length,
        true,
      )
...
function getPPTTextFontWeightSourceFromJSONValue(
  value: unknown,
  jsonLength: number,
  allowDirect: boolean,
): PPTTextFontWeightImportSource | null {
  const payload = getPPTTextFontWeightPayloadEntry(value, allowDirect)

  if (!payload) {
    return null
  }

  const fontWeight = getPPTTextFontWeightImportValueFromJSONValue(
    payload.value,
  )
...
function getPPTTextFontWeightPayloadEntry(
  value: unknown,
  allowDirect: boolean,
): {
  fields: readonly PPTTextFontWeightImportField[]
...
function getPPTTextFontWeightImportValueFromJSONValue(
  value: unknown,
): PPTTextStyle['fontWeight'] | undefined {
  if (isPPTRecord(value)) {
    return getPPTTextFontWeightImportValueFromJSONValue(
      value.value ??
        value.fontWeight ??
        value.weight ??
