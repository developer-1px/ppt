...
export const PPT_CANVAS_IMAGE_FILE_IMPORT_SUPPORTED_FORMATS =
  CANVAS_IMAGE_FILE_IMPORT_SUPPORTED_FORMATS
export const PPT_CANVAS_IMAGE_SOURCE_IMPORT_SUPPORTED_FORMATS =
  CANVAS_IMAGE_SOURCE_IMPORT_SUPPORTED_FORMATS
export const PPT_CANVAS_MEDIA_IMPORT_MODEL = CANVAS_MEDIA_IMPORT_MODEL
export const PPT_CANVAS_MEDIA_SOURCE_IMPORT_SUPPORTED_FORMATS =
  CANVAS_MEDIA_SOURCE_IMPORT_SUPPORTED_FORMATS
...
export const PPT_KEYBOARD_SELECTION_CYCLE_MODEL =
  CANVAS_KEYBOARD_SELECTION_CYCLE_MODEL
export const PPT_KEYBOARD_TEXT_EDIT_START_INTENT_MODEL =
  CANVAS_KEYBOARD_TEXT_EDIT_START_INTENT_MODEL
export const PPT_KEYBOARD_TEXT_EDIT_START_KEYS =
  CANVAS_KEYBOARD_TEXT_EDIT_START_KEYS
...
export const readPPTCanvasDataTransferJSONCandidate =
  readCanvasDataTransferJSONCandidate
export const readPPTCanvasDataTransferTextCandidate =
  readCanvasDataTransferTextCandidate
