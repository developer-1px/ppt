...
- `pptObjectAdapter.ts`: 모든 PPT 객체에 공통인 opacity, hyperlink, accessibility, shadow와 fill, stroke, corner radius 값을 정규화하고 canvas descriptor·CSS로 변환한다. 렌더링·명령 처리·Inspector가 같은 객체 의미를 사용하게 하는 경계다.
